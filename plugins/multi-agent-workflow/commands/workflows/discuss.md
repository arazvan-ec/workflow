...
ROUTE ──> [DISCUSS] ──> SHAPE ──> PLAN ──> WORK ──> ...
              ...
              └── Writes: 01_preferences.md
                  Read by: /workflows:plan (Step 0.1)
```
...
```markdown
Para planificar ${FEATURE_ID}, necesito conocer tus preferencias:
...
The planner reads preferences at Step 0.1 and does NOT ask questions already answered in the preferences file.
