...
- **`plan`** completeness: Before setting planner to `COMPLETED`, the Plan Completeness Verification must pass (all files exist on disk, substantive content verified, original request covered). See `plan.md` Completeness Verification section.
