...
3. Ejecutar el skill `/workflow:source-report` para obtener el informe completo de fuentes
...
*Usar `/workflow:source-report` para ver el informe detallado de fuentes.*
