...
# Copy workflow wrapper
cp "$SCRIPT_DIR/workflow" "$TARGET_DIR/workflow"
chmod +x "$TARGET_DIR/workflow"
success "Copied workflow command wrapper"
...
echo "   ${CYAN}./workflow help${NC}"
echo ""
echo "3. Run the workflow consultant (recommended):"
echo "   ${CYAN}./workflow consult${NC}"
echo ""
echo "4. Start as a specific role:"
echo "   ${CYAN}./workflow role planner my-feature${NC}"
echo "   ${CYAN}./workflow role backend my-feature${NC}"
echo ""
echo "5. Or start all roles in Tilix:"
echo "   ${CYAN}./workflow start my-feature default --execute${NC}"
echo ""
echo "6. Install git hooks (recommended):"
